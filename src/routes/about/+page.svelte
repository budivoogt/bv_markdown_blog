...
<div class="my-8">
	...
	<ProjectList>
		...
		<Project
			...
			acquired="(Exited)"
		/>
		<Project name="Heroic Academy" description="Music industry education platform" />
		<Project
			name="The SoundCloud Bible"
			description="Book about SoundCloud and music marketing"
		/>
		<Project
			name="Heroic"
